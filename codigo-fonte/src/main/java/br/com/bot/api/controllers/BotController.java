...
public class BotController {
    ...
    public ResponseEntity<Bot> get(@PathVariable("id") String id) {
        ...
        Bot bot = null;
        try {
            bot = service.findById(id);
        } catch (BusinessException e) {
            status = HttpStatus.NO_CONTENT;
        }
        return new ResponseEntity<>(bot, status);
    }
    ...
    public ResponseEntity<?> delete(@PathVariable("id") String id) {
        ...
        try {
            ...
            response = new ResponseEntity<>(new ErrorDTO(e.getMessage()), HttpStatus.FORBIDDEN);
        }
        return response;
    }
    ...
    public ResponseEntity<?> put(@PathVariable("id") String id, @RequestBody BotDTO botDTO) {
